...
public class Escolha1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(escolhapoke == 1) {
            ...
            tv_golpe1.setText("Força do golpe: 25            Custo do golpe:30");
            tv_golpe2.setText("Força do golpe: 50            Custo do golpe:50");
            tv_golpe3.setText("Força do golpe: 80            Custo do golpe:70");
            btn_golpe1.setText("Ataque fraco");
            btn_golpe2.setText("Ataque médio");
            btn_golpe3.setText("Ataque forte");
            ...
            btn_golpe1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (Score.energia1 > 29) {
                        ...
                        Toast.makeText(getBaseContext(), "MANA INSUFICIENTE", Toast.LENGTH_LONG).show();
            ...
            tv_golpe1.setText("Força do golpe: 25            Custo do golpe:35");
            tv_golpe2.setText("Força do golpe: 45            Custo do golpe:50");
            tv_golpe3.setText("Força do golpe: 90            Custo do golpe:85");
            btn_golpe1.setText("Ataque fraco");
            btn_golpe2.setText("Ataque médio");
            btn_golpe3.setText("Ataque forte");
            ...
            tv_golpe1.setText("Força do golpe: 20            Custo do golpe:30");
            tv_golpe2.setText("Força do golpe: 45            Custo do golpe:60");
            tv_golpe3.setText("Força do golpe: 100            Custo do golpe:100");
            btn_golpe1.setText("Ataque fraco");
            btn_golpe2.setText("Ataque médio");
            btn_golpe3.setText("Ataque forte");
